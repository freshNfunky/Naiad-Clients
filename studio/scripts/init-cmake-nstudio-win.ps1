...
remove-item $env:DEV_ROOT_NSTUDIO/stage-$env:EM_PLAT-$env:EM_ARCH -force -recurse
new-item $env:DEV_ROOT_NSTUDIO/stage-$env:EM_PLAT-$env:EM_ARCH -force -type directory 
