...
remove-item $env:DEV_ROOT_NSTUDIO/stage-$env:EM_PLAT-$env:EM_ARCH/release -force -recurse
...
#$env:dcmakecmd = "cmake -DCMAKE_BUILD_TYPE=DEBUG   -DCMAKE_INSTALL_PREFIX=$env:NAIAD_PATH_DBG $env:DEV_ROOT_NSTUDIO -G `"Visual Studio 10 Win64`""
